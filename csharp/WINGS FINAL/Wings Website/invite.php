...
<h1>Invite Friend</h1>
	<div class="form">
		<div class="form-1">
<form name="reserve" method="post" action="friend.php" onSubmit="return InputCheck(this)">
<p>
<label for="reserve" class="label">Do you want invite friend with you?</label>
</p>
<p>
<label for="tent">Tent Number:</label><br/>
<?php
echo $_GET['tentNo'];
?>
</p>
...
<p>
<label for="email" class="label">E-mail of friend:</label><br/>
...
<img src="./images/li.gif" style="position:absolute;left:330px;bottom:-450px">
