...
$tms = $row['Total_Money_Sent']+$money;
$mia = $row['Money_In_Account']+$money;
//写入数据
$sql = "UPDATE `account` SET Total_Money_Sent = $tms, Money_In_Account = $mia WHERE Customer_Id=$userid";
if(mysql_query($sql,$conn)){
    exit('Money transferred! <a href="my.html">Bcak to my profile!</a>');
} else {
