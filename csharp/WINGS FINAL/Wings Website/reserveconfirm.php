...
<h1>Reserve Tent</h1>
	<div class="form">
		<div class="form-1">
<form name="reserve" method="post" action="reserve.php" onSubmit="return InputCheck(this)">
<p>
<label for="reserve" class="label">Do you want to reserve this tent?</label>
<?php

echo '<input type="hidden" name="tentNo" value="',$_GET['tentNo'],'"/>'
?>
</p>
<p>
<input type="submit" name="submit" value="  Submit  " class="left" />  <input type="submit" name="back" value="back"  onclick="history.back()"/>
</p>


<p><label for="reserve" class="label">
<?php
echo '<a href ="invite.php?tentNo=',$_GET['tentNo'],'">Do you want invite friend with you? </a>';
?>
</label></p>
</form>	 


<img src="./images/li.gif" style="position:absolute;left:330px;bottom:-250px">
